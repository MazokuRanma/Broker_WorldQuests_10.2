				...
				if questTagInfo and questTagInfo.worldQuestType then
					...
					for i = 1, numQuestCurrencies do
						...
						if name then
							...
							elseif currencyId == 2652 then -- DREAM_WARDENS
								rewardType[#rewardType+1] = CONSTANTS.REWARD_TYPES.DREAM_WARDENS
								quest.reward.DREAM_WARDENSAmount = currency.amount
								if C("showDREAM_WARDENS") then quest.hide = false end
							elseif currencyId == 2650 then -- Emerald Dewdrop
								rewardType[#rewardType+1] = CONSTANTS.REWARD_TYPES.EMERALD_DEWDROP
								quest.reward.EmeraldDewdropAmount = currency.amount
								if C("showEmeraldDewdrop") then quest.hide = false end
					...
					if not quest.hide then
						...
						if rewardType then
							for _, rtype in next, rewardType do
								...
								elseif rtype == CONSTANTS.REWARD_TYPES.EMERALD_DEWDROP then
									BWQ.totalEmeraldDewdrop = BWQ.totalEmeraldDewdrop + quest.reward.EmeraldDewdropAmount
								...
								elseif rtype == CONSTANTS.REWARD_TYPES.DREAM_WARDENS then
									BWQ.totalDREAM_WARDENS = BWQ.totalDREAM_WARDENS + quest.reward.DREAM_WARDENSAmount
...
function BWQ:UpdateBlock()
	...
	if C("showTotalsInBrokerText") then
		...
		if C("brokerShowEmeraldDewdrop") 	    	and BWQ.totalEmeraldDewdrop > 0		    	then brokerString = string.format("%s|TInterface\\Icons\\inv_misc_shadowdew:16:16|t %d  ", brokerString, BWQ.totalEmeraldDewdrop) end
		...
		if C("brokerShowDREAM_WARDENS") 	       	and BWQ.totalDREAM_WARDENS > 0		    	then brokerString = string.format("%s|TInterface\\Icons\\ui_majorfaction_denizens:16:16|t %d  ", brokerString, BWQ.totalDREAM_WARDENS) end
...
function BWQ:SetupConfigMenu()
	local options = {
		...
		{ text = "Show total counts in broker text", check = "showTotalsInBrokerText", submenu = {
				...
				{ text = ("|T%1$s:16:16|t  Emerald Dewdrop"):format("Interface\\Icons\\inv_misc_shadowdew"), check = "brokerShowEmeraldDewdrop" },
				{ text = ("|T%1$s:16:16|t  Whelpling's Dreaming Crest"):format("Interface\\Icons\\inv_10_gearupgrade_whelplingsdreamingcrest"), check = "brokerShowWhelplingsDreamingCrest" },
				{ text = ("|T%1$s:16:16|t  Drake's Dreaming Crest"):format("Interface\\Icons\\inv_10_gearupgrade_drakesdreamingcrest"), check = "brokerShowDrakesDreamingCrest" },
				{ text = ("|T%1$s:16:16|t  Loamm Niffen"):format("Interface\\Icons\\ui_majorfaction_niffen"), check = "brokerShowLOAMM_NIFFEN" },
				{ text = ("|T%1$s:16:16|t  Dream Wardens"):format("Interface\\Icons\\ui_majorfaction_denizens"), check = "brokerShowDREAM_WARDENS" },
		...
		{ text = ("|T%1$s:16:16|t  Emerald Dewdrop"):format("Interface\\Icons\\inv_misc_shadowdew"), check = "showEmeraldDewdrop" },
		{ text = ("|T%1$s:16:16|t  Whelpling's Dreaming Crest"):format("Interface\\Icons\\inv_10_gearupgrade_whelplingsdreamingcrest"), check = "showWhelplingsDreamingCrest" },
		{ text = ("|T%1$s:16:16|t  Drake's Dreaming Crest"):format("Interface\\Icons\\inv_10_gearupgrade_drakesdreamingcrest"), check = "showDrakesDreamingCrest" },
		{ text = ("|T%1$s:16:16|t  Loamm Niffen"):format("Interface\\Icons\\ui_majorfaction_niffen"), check = "showLOAMM_NIFFEN" },
		{ text = ("|T%1$s:16:16|t  Dream Wardens"):format("Interface\\Icons\\ui_majorfaction_denizens"), check = "showDREAM_WARDENS" },
